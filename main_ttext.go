...
func TTextFromBaseTemporal[T1 Temporal, T2 Temporal](value string, base T1, output T2) T2 {
	c_temp := C.ttext_from_base_temp(C.text_in(C.CString(value)), base.Inner())
	output.Init(c_temp)
	return output
}
...
func TTextInstMake(value string, base time.Time) *TTextInst {
	res := C.ttextinst_make(C.text_in(C.CString(value)), DatetimeToTimestamptz(base))
...
func TTextSeqFromBaseTstzset(value string, base TsTzSet) *TTextSeq {
	res := C.ttextseq_from_base_tstzset(C.text_in(C.CString(value)), base._inner)
...
func TTextSeqFromBaseTstzspan(value string, base TsTzSpan) *TTextSeq {
	res := C.ttextseq_from_base_tstzspan(C.text_in(C.CString(value)), base._inner)
	return &TTextSeq{_inner: C.cast_tsequence_to_temporal(res)}
}
...
func TTextSeqSetFromBaseTstzspanset(value string, base *TsTzSpanSet) *TTextSeqSet {
	res := C.ttextseqset_from_base_tstzspanset(C.text_in(C.CString(value)), base._inner)
...
func AlwaysLtTTextText[TT TText](tt TT, value string) bool {
	return int(C.always_lt_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func AlwaysLeTTextText[TT TText](tt TT, value string) bool {
	return int(C.always_le_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func AlwaysEqTTextText[TT TText](tt TT, value string) bool {
	return int(C.always_eq_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func AlwaysNeTTextText[TT TText](tt TT, value string) bool {
	return int(C.always_ne_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func AlwaysGeTTextText[TT TText](tt TT, value string) bool {
	return int(C.always_ge_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func AlwaysGtTTextText[TT TText](tt TT, value string) bool {
	return int(C.always_gt_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func EverLtTTextText[TT TText](tt TT, value string) bool {
	return int(C.ever_lt_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func EverLeTTextText[TT TText](tt TT, value string) bool {
	return int(C.ever_le_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func EverEqTTextText[TT TText](tt TT, value string) bool {
	return int(C.ever_eq_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func EverNeTTextText[TT TText](tt TT, value string) bool {
	return int(C.ever_ne_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func EverGeTTextText[TT TText](tt TT, value string) bool {
	return int(C.ever_ge_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func EverGtTTextText[TT TText](tt TT, value string) bool {
	return int(C.ever_gt_ttext_text(tt.Inner(), C.text_in(C.CString(value)))) > 0
}
...
func TEqTTextText[TT TText](tt TT, value string) Temporal {
	c_temp := C.teq_ttext_text(tt.Inner(), C.text_in(C.CString(value)))
...
func TNeTTextText[TT TText](tt TT, value string) Temporal {
	c_temp := C.tne_ttext_text(tt.Inner(), C.text_in(C.CString(value)))
	return CreateTemporal(c_temp)
}
...
func TLtTTextText[TT TText](tt TT, value string) Temporal {
	c_temp := C.tlt_ttext_text(tt.Inner(), C.text_in(C.CString(value)))
	return CreateTemporal(c_temp)
}
...
func TLeTTextText[TT TText](tt TT, value string) Temporal {
	c_temp := C.tle_ttext_text(tt.Inner(), C.text_in(C.CString(value)))
	return CreateTemporal(c_temp)
}
...
func TGeTTextText[TT TText](tt TT, value string) Temporal {
	c_temp := C.tge_ttext_text(tt.Inner(), C.text_in(C.CString(value)))
	return CreateTemporal(c_temp)
}
...
func TGtTTextText[TT TText](tt TT, value string) Temporal {
	c_temp := C.tgt_ttext_text(tt.Inner(), C.text_in(C.CString(value)))
	return CreateTemporal(c_temp)
}

// TTextAtValue Return a temporal int restricted to a string
func TTextAtValue[TT TText](tt TT, value string) Temporal {
	c_ttexts := C.ttext_at_value(tt.Inner(), C.text_in(C.CString(value)))
...
func TTextMinusValue[TT TText](tt TT, value string) Temporal {
	c_ttexts := C.ttext_minus_value(tt.Inner(), C.text_in(C.CString(value)))
	return CreateTemporal(c_ttexts)
}

// Return the concatenation of a temporal text and a text
func TextcatTTextText[TT TText](tt TT, value string) Temporal {
	c_temp := C.textcat_ttext_text(tt.Inner(), C.text_in(C.CString(value)))
	return CreateTemporal(c_temp)
}
