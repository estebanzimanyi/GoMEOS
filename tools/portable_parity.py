...
references (`C.<symbol>(`):
  ...
  * the IDL-driven generated surface under `tools/_preview/*.go`, which
...
def exposed_symbols(repo: Path) -> list[str]:
    ...
    package plus the IDL-driven generated surface (tools/_preview)."""
    syms: set[str] = set()
...
def build_parity(symbols: list[str], pa: dict) -> dict:
    ...
    return {
        ...
        "symbolSources": ["repo-root *.go (hand-written)",
                          "tools/_preview/*.go (IDL-driven codegen "
